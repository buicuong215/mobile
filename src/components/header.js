    ...
    color: black;
      ...
      <div class="logo"><a href="/index.html">Mobile Store</a></div>
       <div class="input">
        ...
        <nav class="nav">
            <a href="http://127.0.0.1:8080/src/pages/products/products.html" class="nav-item">
                <ion-icon name="phone-portrait-outline"></ion-icon>
                <div>Điện Thoại</div>
            </a>
            <a href="http://127.0.0.1:8080/src/pages/cart/cart.html" class="nav-item">
                <ion-icon name="cart-outline"></ion-icon>
               <div>Giỏ Hàng</div> 
            </a>
            <a href="http://127.0.0.1:8080/src/pages/sign/sign.html" class="nav-item">
